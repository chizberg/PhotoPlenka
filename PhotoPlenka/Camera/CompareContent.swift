...
final class CompareContent: UIView {
    ...
    private lazy var previewRatioConstraint = newImagePreview.heightAnchor.constraint(equalTo: newImagePreview.widthAnchor, multiplier: Constants.horizontalRatio)
    ...
    private func applyConstraints(){
        ...
        NSLayoutConstraint.activate([
            ...
            oldImageView.heightAnchor.constraint(equalTo: oldImageView.widthAnchor, multiplier: Constants.horizontalRatio),
            newImageView.heightAnchor.constraint(equalTo: newImageView.widthAnchor, multiplier: Constants.horizontalRatio)
        ])

        //alphaSlider
        NSLayoutConstraint.activate([
            alphaSlider.leadingAnchor.constraint(equalTo: sliderContainer.leadingAnchor, constant: Constants.sliderHorizontalInset),
            alphaSlider.trailingAnchor.constraint(equalTo: sliderContainer.trailingAnchor, constant: -Constants.sliderHorizontalInset),
            alphaSlider.topAnchor.constraint(equalTo: sliderContainer.topAnchor, constant: Constants.sliderVerticalInset),
            alphaSlider.bottomAnchor.constraint(equalTo: sliderContainer.bottomAnchor, constant: -Constants.sliderVerticalInset)
        ])
    ...
    private func updateRatioConstraint(isVertical: Bool){
        ...
        previewRatioConstraint = newImagePreview.heightAnchor.constraint(equalTo: newImagePreview.widthAnchor, multiplier: newRatio)
