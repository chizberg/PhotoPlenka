...
final class CameraCompareController: UIViewController {
    ...
    func applyConstraints(){
        NSLayoutConstraint.activate([
            ...
            compareContent.leadingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.leadingAnchor),
            compareContent.trailingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.trailingAnchor),
    ...
    private func askExportMode(){
        ...
        let separately = UIAlertAction(title: "По отдельности", style: .default, handler: { [weak self] _ in
            guard let self = self else {return}
