...
extension MapApps {
    ...
    private func coordinateLink(latitude: Double, longitude: Double) -> URL? {
        ...
        case .doubleGis:
            return URL(string: "dgis://2gis.ru/routeSearch/rsType/pedestrian/to/\(longitude),\(latitude)")
        case .google:
    ...
    func open(latitude: Double, longitude: Double){
        guard let coordinateLink = coordinateLink(latitude: latitude, longitude: longitude) else { return }
