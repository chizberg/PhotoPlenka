...
final class CameraViewFactory {
  private enum Style {
    ...
    static let upArrow: UIImage = .init(systemName: "arrowtriangle.up.fill")!
    static let downArrow: UIImage = .init(systemName: "arrowtriangle.down.fill")!
    static let yearFont: UIFont = .init(name: "Menlo-Bold", size: 13)!
    static let yearMargins: UIEdgeInsets = .init(top: 0, left: 16, bottom: 0, right: 16)
    static let backIcon: UIImage = .init(systemName: "chevron.left")!
